...
(function($) {
	...
	$.fn.poshytip.defaults = {
		...
		offsetX:		-22,		// offset X pixels form the default position - doesn't matter if alignX:'center'
		offsetY:		18,		// offset Y pixels form the default position - doesn't matter if alignY:'center'
